...
var getCharacterReference;
module.link("./charref", {
  getCharacterReference: function (v) {
    getCharacterReference = v;
  }
}, 0);
var asciiLowerCase, properCaseTagName, properCaseAttributeName;
module.link("./utils", {
  asciiLowerCase: function (v) {
    asciiLowerCase = v;
  },
  properCaseTagName: function (v) {
    properCaseTagName = v;
  },
  properCaseAttributeName: function (v) {
...
var parseFragment, codePointToString, getContent, getRCData;
module.link("./parse", {
  parseFragment: function (v) {
    parseFragment = v;
  },
  codePointToString: function (v) {
    codePointToString = v;
  },
  getContent: function (v) {
    getContent = v;
  },
  getRCData: function (v) {
    getRCData = v;
  }
}, 4);
var getComment, getDoctype, getHTMLToken, getTagToken, TEMPLATE_TAG_POSITION;
module.link("./tokenize", {
  getComment: function (v) {
    getComment = v;
  },
  getDoctype: function (v) {
    getDoctype = v;
  },
  getHTMLToken: function (v) {
    getHTMLToken = v;
  },
  getTagToken: function (v) {
    getTagToken = v;
  },
  TEMPLATE_TAG_POSITION: function (v) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
module.export({
  getCharacterReference: function () {
    return getCharacterReference;
  }
});
var makeRegexMatcher;
module.link("./scanner", {
  makeRegexMatcher: function (v) {
    makeRegexMatcher = v;
  }
}, 0);
...
(function () {
  ...
  for (var ent in meteorBabelHelpers.sanitizeForInObject(ENTITIES)) {
  ...
  for (var chr in meteorBabelHelpers.sanitizeForInObject(namedEntitiesByFirstChar)) {
...
var properCaseAttributeName;
module.link("./utils", {
  properCaseAttributeName: function (v) {
    properCaseAttributeName = v;
  }
}, 2);
var getHTMLToken, isLookingAtEndTag;
module.link("./tokenize", {
  getHTMLToken: function (v) {
    getHTMLToken = v;
  },
  isLookingAtEndTag: function (v) {
    isLookingAtEndTag = v;
  }
}, 3);
...
module.export({
  ...
  makeRegexMatcher: function () {
    return makeRegexMatcher;
  }
});
...
module.export({
  ...
  getHTMLToken: function () {
    return getHTMLToken;
  },
  getTagToken: function () {
    return getTagToken;
  },
  TEMPLATE_TAG_POSITION: function () {
    return TEMPLATE_TAG_POSITION;
  },
  isLookingAtEndTag: function () {
    return isLookingAtEndTag;
  }
});
var asciiLowerCase, properCaseTagName, properCaseAttributeName;
module.link("./utils", {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
module.export({
  asciiLowerCase: function () {
    return asciiLowerCase;
  },
  properCaseTagName: function () {
    return properCaseTagName;
  },
  properCaseAttributeName: function () {
    return properCaseAttributeName;
  }
});
var HTML;
module.link("meteor/htmljs", {
