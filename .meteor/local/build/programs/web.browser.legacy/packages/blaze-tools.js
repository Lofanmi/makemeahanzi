...
var EmitCode, toJSLiteral, toObjectLiteralKey, ToJSVisitor, toJS;
module.link("./tojs", {
  EmitCode: function (v) {
    EmitCode = v;
  },
  toJSLiteral: function (v) {
    toJSLiteral = v;
  },
  toObjectLiteralKey: function (v) {
    toObjectLiteralKey = v;
  },
  ToJSVisitor: function (v) {
    ToJSVisitor = v;
  },
  toJS: function (v) {
    toJS = v;
...
var parseNumber, parseIdentifierName, parseExtendedIdentifierName, parseStringLiteral;
module.link("./tokens", {
  parseNumber: function (v) {
    parseNumber = v;
  },
  parseIdentifierName: function (v) {
    parseIdentifierName = v;
  },
  parseExtendedIdentifierName: function (v) {
    parseExtendedIdentifierName = v;
  },
  parseStringLiteral: function (v) {
...
module.export({
  ...
  toJSLiteral: function () {
    return toJSLiteral;
  },
  toObjectLiteralKey: function () {
    return toObjectLiteralKey;
  },
  ToJSVisitor: function () {
    return ToJSVisitor;
  },
  toJS: function () {
    return toJS;
...
var ToJSVisitor = HTML.Visitor.extend();
ToJSVisitor.def({
  ...
  generateAttrsDictionary: function (attrsDict) {
    ...
    for (var k in meteorBabelHelpers.sanitizeForInObject(attrsDict)) {
...
module.export({
  ...
  parseIdentifierName: function () {
    return parseIdentifierName;
  },
  parseExtendedIdentifierName: function () {
