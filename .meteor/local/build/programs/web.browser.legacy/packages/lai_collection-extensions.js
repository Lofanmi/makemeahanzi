...
function wrapCollection(ns, as) {
  ...
  ns.Collection = function () {
    var ret = constructor.apply(this, arguments); // This is where all the collection extensions get processed
  ...
  for (var prop in meteorBabelHelpers.sanitizeForInObject(constructor)) {
...
function processCollectionExtensions(self, args) {
  ...
  var applyArgs = args ? [].slice.call(args, 0) : undefined;
